...
OfdmPpdu::LSigHeader::SetRate(uint64_t rate, MHz_u channelWidth)
{
    ...
    case 54000000:
        m_rate = 0b0011;
        break;
    case 65000000: m_rate = 0b0100; break; // will map back to 32.5 Mb/s at 10 MHz
    case 78000000: m_rate = 0b0110; break; // will map back to 39 Mb/s at 10 MHz
    default:
...
OfdmPpdu::LSigHeader::GetRate(MHz_u channelWidth) const
{
    ...
    case 0b0011:
        rate = 54000000;
        break;
    case 0b0100: rate = 65000000; break; // 65 Mb/s
    case 0b0110: rate = 78000000; break; // 78 Mb/s
    default:
        NS_ASSERT_MSG(false, "Invalid rate");
        break;
    }
