...
class OfdmPhy : public PhyEntity
{
  public:
    ...
    static WifiMode GetOfdmRate32_5MbpsBW10MHz();   // <--- add
    static WifiMode GetOfdmRate39MbpsBW10MHz();
    /**
  ...
  private:
    ...
    // Lazy getters avoid static-init ordering issues when Bd registers itself at startup.
    static const PpduFormats& GetOfdmPpduFormatsTable();
    static const ModulationLookupTable& GetOfdmModulationLookupTable();
};
