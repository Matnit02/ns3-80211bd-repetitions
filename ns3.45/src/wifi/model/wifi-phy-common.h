...
enum WifiModulationClass
{
    ...
    WIFI_MOD_CLASS_BD,        //!< BD/NGV (custom class)
...
enum WifiPpduField
{
    ...
    // Added fields
    WIFI_PPDU_FIELD_RL_SIG,
    WIFI_PPDU_FIELD_NGV_SIG,
    WIFI_PPDU_FIELD_RNGV_SIG,
    WIFI_PPDU_FIELD_NGV_STF,
    WIFI_PPDU_FIELD_NGV_LTF
};
...
/** Track whether 802.11bd standard is active (used for preamble selection). */
void SetBdStandardSelected(bool enabled);
bool IsBdStandardSelected();
